                ...
                <Table className='tblData'>
                    ...
                    <tbody>
                        {search(data).map((dato,index)=>(
                            <tr key={index}>
                                <td style={{padding:'8px 8px 8px 25px'}}><Avatar src={dato.imgServicio} sx={{ width: 37, height: 37}} /></td>
                                ...
                                </svg></Button> <Button color='danger' onClick={()=>eliminar(dato)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
