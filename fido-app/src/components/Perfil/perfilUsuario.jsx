          ...
          <Table className="tblData">
            ...
            <tbody>
                {state.data.map((elemento)=>(
                    <tr>
                        <td style={{paddingLeft:'20px'}}><Avatar src={elemento.imgPerfil} sx={{ width: 33, height: 33}} /></td>
                        <td style={{paddingTop:'15px'}}>{elemento.nombre} {elemento.apellidos}</td>
                        <td style={{paddingTop:'15px'}}>{elemento.email}</td>
                        <td style={{paddingTop:'15px'}}>{elemento.telefono}</td>
                        <td>
                            {/* <Button style={{backgroundColor:'#8C30F5'}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                ...
                                <Button color="danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
